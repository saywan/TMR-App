...
$translations = [
    'en' => [
        ...
        // Hero
        'hero_title' => 'Architecture of Tomorrow',
        'hero_subtitle' => 'Lasting Structures',
        'hero_desc' => 'Utilizing the most modern civil engineering and architectural methods to turn your dream projects into reality.',
        'hero_btn_primary' => 'Free Consultation',
        'hero_btn_secondary' => 'Our Projects',
        ...
        'service_1_title' => 'Tiefbau (Underground)',
        'service_1_desc' => 'Execution of foundations, tunneling, and heavy structures using advanced machinery.',
        'service_2_title' => 'Modern Architecture',
        'service_2_desc' => 'Design and execution of villas and commercial buildings with glass facades.',
        'service_3_title' => 'Landscaping & Site Work',
        'service_3_desc' => 'Industrial landscaping and green spaces with international standards.',
        'service_4_title' => 'Project Management',
        'service_4_desc' => 'Full-cycle project management from planning to handover with precision.',

        // About Teaser
        'about_teaser_title' => 'Engineering Excellence',
        'about_teaser_desc' => 'With over 20 years of experience in Tiefbau, concrete structures, and modern architecture, Modern Builders is one of the most reputable contractors in the region. We combine German precision with local expertise.',
        ...
        'testimonial_1_text' => 'Modern Builders delivered our commercial complex on time and with exceptional quality. Their team is professional and reliable.',
        ...
        'testimonial_3_text' => 'We have worked with Modern Builders on three major projects. Their commitment to quality is unmatched.',
        ...
        'team_member1_name' => 'John Doe',
        'team_member1_position' => 'CEO & Senior Engineer',
        'team_member2_name' => 'Jane Smith',
        'team_member2_position' => 'Lead Architect',
        'team_member3_name' => 'Michael Brown',
        'team_member3_position' => 'Head of Tiefbau Operations',
        'team_member4_name' => 'Sarah Johnson',
        ...
        'faq_a1' => 'We handle a wide range of projects including residential towers, commercial buildings, bridges, tunnels, landscaping, and industrial civil works.',
        'faq_q2' => 'Do you work outside of the region?',
        'faq_a2' => 'Yes, we have experience working across multiple countries and can mobilize our team and machinery wherever needed.',
        ...
        'news_1_title' => 'Modern Builders Completes Major Tunnel Project',
        'news_1_excerpt' => 'We successfully completed the 3km Sardasht tunnel using advanced boring technology...',
        ...
        'contact_address' => 'Tehran, Valiasr St., No. 1020',
        'contact_phone' => '+98-21-12345678',
        'contact_email' => 'info@modernconstructions.com',
        'footer_copy' => 'All rights reserved.',
    ],
    'de' => [
        // Header / Navigation
        'brand_name' => 'Moderne Baumeister',
        'nav_home' => 'Startseite',
        'nav_about' => 'Über uns',
        ...
        // Hero
        'hero_title' => 'Architektur von morgen',
        'hero_subtitle' => 'Dauerhafte Strukturen',
        'hero_desc' => 'Mit den modernsten Methoden im Tiefbau und der Architektur verwandeln wir Ihre Traumprojekte in die Realität.',
        'hero_btn_primary' => 'Kostenlose Beratung',
        'hero_btn_secondary' => 'Unsere Projekte',
        ...
        'stat_countries' => 'Länder betreut',

        // Services
        'services_title' => 'Unsere spezialisierten Leistungen',
        'services_subtitle' => 'Was wir am besten können',
        'service_1_title' => 'Tiefbau',
        'service_1_desc' => 'Ausführung von Fundamenten, Tunnelbau und Schwerstrukturen.',
        'service_2_title' => 'Moderne Architektur',
        'service_2_desc' => 'Design und Ausführung von Villen und Gewerbegebäuden mit Glasfassaden.',
        'service_3_title' => 'Landschaftsbau',
        'service_3_desc' => 'Industrieller Landschaftsbau und Grünflächen nach internationalen Standards.',
        'service_4_title' => 'Projektmanagement',
        'service_4_desc' => 'Vollständiges Projektmanagement von der Planung bis zur Übergabe.',

        // About Teaser
        'about_teaser_title' => 'Technische Exzellenz',
        'about_teaser_desc' => 'Mit über 20 Jahren Erfahrung im Tiefbau, Betonbau und moderner Architektur sind wir einer der renommiertesten Auftragnehmer der Region.',
        ...
        'testimonial_1_text' => 'Moderne Baumeister hat unser Gewerbezentrum termingerecht und mit außergewöhnlicher Qualität geliefert. Ihr Team ist professionell und zuverlässig.',
        'testimonial_1_author' => 'Dr. Markus Weber',
        'testimonial_1_position' => 'CEO, Weber Immobilien',
        ...
        'testimonial_3_text' => 'Wir haben mit Moderne Baumeister an drei großen Projekten gearbeitet. Ihre Qualitätsorientierung ist unübertroffen.',
        'testimonial_3_author' => 'Dr. Anna Fischer',
        ...
        'faq_a1' => 'Wir führen eine breite Palette von Projekten durch, darunter Wohntürme, Gewerbegebäude, Brücken, Tunnel, Landschaftsbau und Tiefbauarbeiten.',
        'faq_q2' => 'Arbeiten Sie außerhalb der Region?',
        'faq_a2' => 'Ja, wir haben Erfahrung in mehreren Ländern und können unser Team und unsere Maschinen überall einsetzen.',
        ...
        'news_1_title' => 'Moderne Baumeister schließt Großprojekt Tunnel ab',
        'news_1_excerpt' => 'Wir haben den 3 km langen Sardasht-Tunnel erfolgreich mit modernster Technologie fertiggestellt...',
        ...
        // Contact Info
        'contact_address' => 'Tehran, Valiasr Str., Nr. 1020',
        'contact_phone' => '+98-21-12345678',
        'contact_email' => 'info@modernconstructions.com',
...
// Project data (for showcase & detail)
$completed_projects = [
    ['id' => 0, 'title' => 'Pars Residential Tower', 'img' => 'https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?w=800&h=600&fit=crop', 'desc' => '25-story structure with curtain wall facade'],
    ['id' => 1, 'title' => 'Karaj Railway Bridge', 'img' => 'https://images.unsplash.com/photo-1574594665792-3db2c44f8b33?w=800&h=600&fit=crop', 'desc' => 'Concrete bridge with a 120-meter span'],
];
$ongoing_projects = [
    ['id' => 2, 'title' => 'Sardasht Tunnel', 'img' => 'https://images.unsplash.com/photo-1574158622682-e40e69881006?w=800&h=600&fit=crop', 'desc' => 'Mechanical drilling with a length of 3 km'],
    ['id' => 3, 'title' => 'Vanak Office Complex', 'img' => 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=800&h=600&fit=crop', 'desc' => 'Steel structure with a total area of 5000 m²'],
];
...
<head>
    ...
    <title><?php echo $t['brand_name']; ?> | Official Website</title>
    ...
    <style>
        ...
        * {
        ...
        .hero-section {
            ...
            align-items: center;
            position: relative;
            background: linear-gradient(135deg, #0B1E36 0%, #1A3A5C 50%, #0B1E36 100%);
            padding-top: 90px;
            overflow: hidden;
        }
        ...
        .hero-section::before {
            ...
            position: absolute;
            inset: 0;
            background: url('https://images.unsplash.com/photo-1541888946425-d81bb19240f5?w=1600&q=80') no-repeat center center/cover;
            opacity: 0.2;
            z-index: 0;
            filter: grayscale(30%);
        }
        ...
        .project-showcase-item .overlay {
            ...
            background: linear-gradient(to top, rgba(11, 30, 54, 0.95), transparent);
            backdrop-filter: blur(6px);
        }

        .project-showcase-item .overlay h6 {
            font-weight: 700;
            font-size: 1.2rem;
        }

        .project-showcase-item .overlay p {
            font-size: 0.9rem;
            color: var(--text-muted);
            margin: 0;
        }
        ...
        /* ===== CTA FINAL ===== */
        .cta-final {
            background: linear-gradient(135deg, rgba(11, 30, 54, 0.8), rgba(26, 58, 92, 0.8));
            backdrop-filter: blur(10px);
            border: 1px solid var(--glass-border);
            border-radius: 40px;
            padding: 60px 50px;
        ...
        @media (max-width: 576px) {
            ...
            .hero-glass-card .btn-gold,
            .hero-glass-card .btn-outline-glass {
                width: 100%;
                text-align: center;
                margin-bottom: 10px;
            }
...
<body>
    ...
    <!-- ==========================================
    MAIN CONTENT – فقط صفحه‌ی HOME (خانه)
    ========================================== -->
    <?php if ($page == 'home'): ?>
        ...
        <section class="hero-section" id="home">
            <div class="container hero-content">
                <div class="row justify-content-start">
                    <div class="col-lg-8 col-md-10" data-aos="fade-right" data-aos-duration="1000">
                        <div class="hero-glass-card">
                            <span class="badge-hero d-inline-block mb-3"><i class="fas fa-star me-2"></i><?php echo strtoupper($t['brand_name']); ?></span>
                            ...
                            <div class="d-flex flex-wrap gap-3">
                                ...
                                <a href="?lang=<?php echo $lang; ?>&page=projects" class="btn btn-outline-glass"><i class="fas fa-arrow-right me-2"></i><?php echo $t['hero_btn_secondary']; ?></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row g-4 text-center">
                    ...
                    <div class="col-md-3 col-6" data-aos="zoom-in" data-aos-delay="200">
                        <div class="glass-light p-4">
                            <h2 class="text-gold" style="color:var(--accent-gold); font-weight:900;">80</h2>
            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6" data-aos="fade-right">
                        <img src="https://images.unsplash.com/photo-1504917595217-d4dc5ebe6122?w=800&q=80" alt="About" class="img-fluid rounded-4 shadow-lg" style="border: 1px solid rgba(255,255,255,0.1);">
                    </div>
                ...
                <div class="row g-4">
                    <div class="col-md-6" data-aos="fade-up" data-aos-delay="100">
                        <div class="glass p-4">
                            ...
                            <p class="text-white-50"><?php echo $t['news_1_excerpt']; ?></p>
                            <a href="#" class="text-gold text-decoration-none" style="color:var(--accent-gold);">Read More →</a>
                        </div>
                    </div>
                    <div class="col-md-6" data-aos="fade-up" data-aos-delay="200">
                        <div class="glass p-4">
                            <h5 class="text-gold" style="color:var(--accent-gold);"><?php echo $t['news_2_title']; ?></h5>
                            <p class="text-white-50"><?php echo $t['news_2_excerpt']; ?></p>
                            <a href="#" class="text-gold text-decoration-none" style="color:var(--accent-gold);">Read More →</a>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        window.addEventListener('scroll', function() {
            ...
            if (window.scrollY > 50) {
                nav.style.background = 'rgba(11, 30, 54, 0.9)';
            } else {
                nav.style.background = 'rgba(11, 30, 54, 0.7)';
            }
        });
    </script>
</body>
